"""
Migração aditiva: adiciona à tabela `tabelas_preco` as colunas do modelo
TabelaPreco (campos migrados da tabela TABELAPRECO do GENUS), sem apagar nada.
...
Execute com: python migrate_add_tabela_preco_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
tabela = TabelaPreco.__tablename__
...
with engine.begin() as conn:
    for coluna in TabelaPreco.__table__.columns:
...
print("Nenhum dado existente em tabelas_preco (ou em qualquer outra tabela) foi apagado ou alterado.")
