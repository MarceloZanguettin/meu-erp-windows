"""
Migração aditiva: cria/expande a tabela `saidas` (modelo Saida — campos
migrados da tabela SAIDA do GENUS), sem apagar nada.
...
Execute com: python migrate_add_saida_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
if tabela not in inspector.get_table_names():
    ...
    Base.metadata.create_all(bind=engine, tables=[Saida.__table__])
...
with engine.begin() as conn:
    for coluna in Saida.__table__.columns:
