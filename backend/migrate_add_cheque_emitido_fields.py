"""
Migração aditiva: cria/expande a tabela `cheques_emitidos` com as colunas do
modelo ChequeEmitido (campos migrados da tabela CHEQUE_EMITIDO do GENUS), sem
apagar nada.
...
Execute com: python migrate_add_cheque_emitido_fields.py (dentro da pasta
...
tabela = ChequeEmitido.__tablename__
...
with engine.begin() as conn:
    for coluna in ChequeEmitido.__table__.columns:
...
print("Nenhum dado existente em cheques_emitidos (ou em qualquer outra tabela) foi apagado ou alterado.")
