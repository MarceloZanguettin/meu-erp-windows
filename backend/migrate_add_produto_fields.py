"""
Migração aditiva: adiciona à tabela `produtos` as colunas novas do modelo
Produto (campos migrados da tabela PRODUTO do GENUS), sem apagar nada.
...
produtos já é feita pela aplicação em controllers/produto_controller.py.

Execute com: python migrate_add_produto_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
with engine.begin() as conn:
    for coluna in Produto.__table__.columns:
...
print("Nenhum dado existente em produtos (ou em qualquer outra tabela) foi apagado ou alterado.")
