"""
Migração aditiva: adiciona à tabela `grupos_produto` as colunas novas do
modelo GrupoProduto (campos migrados da tabela GRUPO do GENUS), sem apagar
nada.
...
Execute com: python migrate_add_grupo_produto_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
from models.tabelas import GrupoProduto

inspector = inspect(engine)
tabela = GrupoProduto.__tablename__
...
with engine.begin() as conn:
    for coluna in GrupoProduto.__table__.columns:
...
print("Nenhum dado existente em grupos_produto (ou em qualquer outra tabela) foi apagado ou alterado.")
