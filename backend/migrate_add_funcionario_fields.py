"""
Migração aditiva: adiciona à tabela `funcionarios` as colunas novas do
modelo Funcionario (campos migrados da tabela FUNCIONARIO do GENUS), sem
apagar nada.
...
Execute com: python migrate_add_funcionario_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
from models.tabelas import Funcionario

inspector = inspect(engine)
tabela = Funcionario.__tablename__
...
with engine.begin() as conn:
    for coluna in Funcionario.__table__.columns:
...
print("Nenhum dado existente em funcionarios (ou em qualquer outra tabela) foi apagado ou alterado.")
