"""
Migração aditiva: cria/expande a tabela `cadastros_cbenef` com as colunas do
modelo CadastroCbenef (campos migrados da tabela CADASTROCBENEF do GENUS),
sem apagar nada.
...
Execute com: python migrate_add_cadastro_cbenef_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
tabela = CadastroCbenef.__tablename__
...
with engine.begin() as conn:
    for coluna in CadastroCbenef.__table__.columns:
...
print("Nenhum dado existente em cadastros_cbenef (ou em qualquer outra tabela) foi apagado ou alterado.")
