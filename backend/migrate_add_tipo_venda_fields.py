"""
Migração aditiva: cria/expande a tabela `tipos_venda` com as colunas do
modelo TipoVenda (campos migrados da tabela TIPOVENDA do GENUS), sem apagar
nada.
...
Execute com: python migrate_add_tipo_venda_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
tabela = TipoVenda.__tablename__
...
with engine.begin() as conn:
    for coluna in TipoVenda.__table__.columns:
...
print("Nenhum dado existente em tipos_venda (ou em qualquer outra tabela) foi apagado ou alterado.")
