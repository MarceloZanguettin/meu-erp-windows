"""
Migração aditiva: adiciona à tabela `clientes_completo` as colunas novas do
modelo ClienteCompleto (campos migrados da tabela CLIENTE do GENUS), sem
apagar nada.
...
Execute com: python migrate_add_cliente_completo_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
from models.tabelas import ClienteCompleto

inspector = inspect(engine)
tabela = ClienteCompleto.__tablename__
...
with engine.begin() as conn:
    for coluna in ClienteCompleto.__table__.columns:
...
print("Nenhum dado existente em clientes_completo (ou em qualquer outra tabela) foi apagado ou alterado.")
