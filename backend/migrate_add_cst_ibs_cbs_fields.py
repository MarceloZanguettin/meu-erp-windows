"""
Migração aditiva: cria/expande a tabela `cst_ibs_cbs` com as colunas do
modelo CstIbsCbs (campos migrados da tabela CST_IBS_CBS do GENUS), sem
apagar nada.
...
Execute com: python migrate_add_cst_ibs_cbs_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
tabela = CstIbsCbs.__tablename__
...
with engine.begin() as conn:
    for coluna in CstIbsCbs.__table__.columns:
...
print("Nenhum dado existente em cst_ibs_cbs (ou em qualquer outra tabela) foi apagado ou alterado.")
