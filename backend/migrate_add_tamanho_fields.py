"""
Migração aditiva: cria/expande a tabela `tamanhos` com as colunas do modelo
Tamanho (campos migrados da tabela TAMANHO do GENUS), sem apagar nada.
...
Execute com: python migrate_add_tamanho_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
with engine.begin() as conn:
    for coluna in Tamanho.__table__.columns:
...
print("Nenhum dado existente em tamanhos (ou em qualquer outra tabela) foi apagado ou alterado.")
