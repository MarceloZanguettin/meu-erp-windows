"""
Migração aditiva: cria/expande a tabela `comissoes` com as colunas do modelo
Comissao (campos migrados da tabela COMISSAO do GENUS), sem apagar nada.
...
Execute com: python migrate_add_comissao_fields.py (dentro da pasta backend,
com o venv ativo)
"""
import sys
import os
...
with engine.begin() as conn:
    for coluna in Comissao.__table__.columns:
...
print("Nenhum dado existente em comissoes (ou em qualquer outra tabela) foi apagado ou alterado.")
