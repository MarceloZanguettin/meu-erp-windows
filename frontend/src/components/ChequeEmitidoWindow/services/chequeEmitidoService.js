 ...
 *
 * Usado tanto pelo hook useCrud (lista/edição em ChequeEmitidoWindow) quanto
 * pela janela de criação NovoChequeEmitidoWindow.
 */
export function normalizarChequeEmitido(form) {
  const dados = { ...form };
