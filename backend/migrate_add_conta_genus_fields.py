"""
Migração aditiva: cria/expande a tabela `contas_genus` com as colunas do
modelo ContaGenus (campos migrados da tabela CONTAS do GENUS), sem apagar
nada.
...
Execute com: python migrate_add_conta_genus_fields.py (dentro da pasta
...
tabela = ContaGenus.__tablename__
...
with engine.begin() as conn:
    for coluna in ContaGenus.__table__.columns:
...
print("Nenhum dado existente em contas_genus (ou em qualquer outra tabela) foi apagado ou alterado.")
