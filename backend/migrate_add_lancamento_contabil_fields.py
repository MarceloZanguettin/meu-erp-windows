"""
Migração aditiva: cria/expande a tabela `lancamentos_contabeis` com as colunas
do modelo LancamentoContabil (campos migrados da tabela LANCAMENTO do GENUS),
sem apagar nada.
...
Execute com: python migrate_add_lancamento_contabil_fields.py (dentro da pasta
...
tabela = LancamentoContabil.__tablename__
...
with engine.begin() as conn:
    for coluna in LancamentoContabil.__table__.columns:
...
print("Nenhum dado existente em lancamentos_contabeis (ou em qualquer outra tabela) foi apagado ou alterado.")
