"""
Migração aditiva: cria/expande a tabela `cfops` com as colunas do modelo
Cfop (campos migrados da tabela CFOP do GENUS), sem apagar nada.
...
Execute com: python migrate_add_cfop_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
with engine.begin() as conn:
    for coluna in Cfop.__table__.columns:
...
print("Nenhum dado existente em cfops (ou em qualquer outra tabela) foi apagado ou alterado.")
