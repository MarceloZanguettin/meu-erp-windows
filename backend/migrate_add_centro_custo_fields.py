"""
Migração aditiva: adiciona à tabela `centros_custo` as colunas novas do
modelo CentroCusto (campos migrados da tabela CENTROCUSTO do GENUS), sem
apagar nada.
...
Execute com: python migrate_add_centro_custo_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
from models.tabelas import CentroCusto

inspector = inspect(engine)
tabela = CentroCusto.__tablename__
...
with engine.begin() as conn:
    for coluna in CentroCusto.__table__.columns:
...
print("Nenhum dado existente em centros_custo (ou em qualquer outra tabela) foi apagado ou alterado.")
