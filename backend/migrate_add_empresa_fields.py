"""
Migração aditiva: adiciona à tabela `empresas` as colunas novas do modelo
Empresa (campos migrados da tabela EMPRESA do GENUS), sem apagar nada.
...
Execute com: python migrate_add_empresa_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
from models.tabelas import Empresa

inspector = inspect(engine)
tabela = Empresa.__tablename__
...
with engine.begin() as conn:
    for coluna in Empresa.__table__.columns:
...
print("Nenhum dado existente em empresas (ou em qualquer outra tabela) foi apagado ou alterado.")
