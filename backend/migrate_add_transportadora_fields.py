"""
Migração aditiva: adiciona à tabela `transportadoras` as colunas novas do
modelo Transportadora (campos migrados da tabela TRANSPORTADOR do GENUS),
sem apagar nada.
...
Execute com: python migrate_add_transportadora_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
from models.tabelas import Transportadora

inspector = inspect(engine)
tabela = Transportadora.__tablename__
...
with engine.begin() as conn:
    for coluna in Transportadora.__table__.columns:
...
print("Nenhum dado existente em transportadoras (ou em qualquer outra tabela) foi apagado ou alterado.")
