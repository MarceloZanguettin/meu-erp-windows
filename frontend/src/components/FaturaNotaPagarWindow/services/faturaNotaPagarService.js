 ...
 *
 * Usado tanto pelo hook useCrud (lista/edição em FaturaNotaPagarWindow)
 * quanto pela janela de criação NovoFaturaNotaPagarWindow.
 */
export function normalizarFaturaNotaPagar(form) {
  const dados = { ...form };
