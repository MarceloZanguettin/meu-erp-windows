...
import TabelaItemPedidoLan from './TabelaItemPedidoLan.jsx';
import TabelaLogAlteracaoPedido from './TabelaLogAlteracaoPedido.jsx';
import TabelaPedidoNota from './TabelaPedidoNota.jsx';
    ...
    <Portal>
      ...
      <div className="modal-content vendas-modal vendas-modal-lg">
        ...
        <div className="modal-body vendas-modal-body">
          ...
          {editandoId && <TabelaItemPedidoLan pedidoId={editandoId} />}
          {editandoId && <TabelaLogAlteracaoPedido pedidoId={editandoId} />}
          {editandoId && <TabelaPedidoNota pedidoId={editandoId} />}
        </div>
