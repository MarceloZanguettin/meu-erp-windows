"""
Migração aditiva: cria/expande a tabela `creditos` com as colunas do modelo
Credito (campos migrados da tabela CREDITO do GENUS), sem apagar nada.
...
Execute com: python migrate_add_credito_fields.py (dentro da pasta backend,
com o venv ativo)
"""
import sys
import os
...
with engine.begin() as conn:
    for coluna in Credito.__table__.columns:
...
print("Nenhum dado existente em creditos (ou em qualquer outra tabela) foi apagado ou alterado.")
