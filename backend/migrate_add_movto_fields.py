"""
Migração aditiva: cria/expande a tabela `movtos` com as colunas do modelo
Movto (campos migrados da tabela MOVTO do GENUS), sem apagar nada.
...
Execute com: python migrate_add_movto_fields.py (dentro da pasta backend,
com o venv ativo)
"""
import sys
import os
...
with engine.begin() as conn:
    for coluna in Movto.__table__.columns:
...
print("Nenhum dado existente em movtos (ou em qualquer outra tabela) foi apagado ou alterado.")
