"""
Migração aditiva: adiciona à tabela `regras_estado` as colunas do modelo
RegraEstado (campos migrados da tabela REGRASESTADO do GENUS), sem apagar nada.
...
Execute com: python migrate_add_regra_estado_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
tabela = RegraEstado.__tablename__
...
with engine.begin() as conn:
    for coluna in RegraEstado.__table__.columns:
...
print("Nenhum dado existente em regras_estado (ou em qualquer outra tabela) foi apagado ou alterado.")
