...
const CAMPOS_GENUS_DATA = ['dt_pedido', 'dt_liberado', 'prazo_entrega'];
...
export default function NovoOrcamentoWindow({ id, onClose, onMinimize, onSalvar }) {
  ...
  return (
    <CadastroFormWindow
      id={id} titulo="Novo Orçamento" onClose={onClose} onMinimize={onMinimize} onSalvar={onSalvar}
      largura={900} altura={580} minLargura={600} minAltura={400}
      salvar={salvar}
    >
