"""
Migração aditiva: adiciona à tabela `fornecedores` as colunas novas do
modelo Fornecedor (campos migrados da tabela FORNECEDOR do GENUS), sem
apagar nada.
...
Execute com: python migrate_add_fornecedor_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
from models.tabelas import Fornecedor

inspector = inspect(engine)
tabela = Fornecedor.__tablename__
...
print("Nenhum dado existente em fornecedores (ou em qualquer outra tabela) foi apagado ou alterado.")
