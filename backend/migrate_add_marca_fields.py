"""
Migração aditiva: cria/expande a tabela `marcas` com as colunas do modelo
Marca (campos migrados da tabela MARCA do GENUS), sem apagar nada.
...
Execute com: python migrate_add_marca_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
with engine.begin() as conn:
    for coluna in Marca.__table__.columns:
...
print("Nenhum dado existente em marcas (ou em qualquer outra tabela) foi apagado ou alterado.")
