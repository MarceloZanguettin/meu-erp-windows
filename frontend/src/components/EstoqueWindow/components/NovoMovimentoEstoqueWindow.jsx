...
export default function NovoMovimentoEstoqueWindow({ id, onClose, onMinimize, onSalvar }) {
  ...
  return (
    <CadastroFormWindow
      id={id} titulo="Lançar Movimento de Estoque" onClose={onClose} onMinimize={onMinimize} onSalvar={onSalvar}
      largura={520} altura={520} minLargura={400} minAltura={380}
      salvar={salvar} labelSalvar="Lançar" labelSalvando="Lançando..."
    >
