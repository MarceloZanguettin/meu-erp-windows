"""
Migração aditiva: cria/expande a tabela `bco_sicred` com as colunas do
modelo BcoSicred (campos migrados da tabela BCOSICRED do GENUS), sem apagar
nada.
...
Execute com: python migrate_add_bco_sicred_fields.py (dentro da pasta
...
tabela = BcoSicred.__tablename__
...
with engine.begin() as conn:
    for coluna in BcoSicred.__table__.columns:
...
print("Nenhum dado existente em bco_sicred (ou em qualquer outra tabela) foi apagado ou alterado.")
