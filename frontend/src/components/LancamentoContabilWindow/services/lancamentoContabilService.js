 ...
 *
 * Usado tanto pelo hook useCrud (lista/edição em LancamentoContabilWindow)
 * quanto pela janela de criação NovoLancamentoContabilWindow.
 */
export function normalizarLancamentoContabil(form) {
  const dados = { ...form };
