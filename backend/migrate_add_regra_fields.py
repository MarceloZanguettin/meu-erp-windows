"""
Migração aditiva: adiciona à tabela `regras` as colunas do modelo Regra
(campos migrados da tabela REGRAS do GENUS), sem apagar nada.
...
Execute com: python migrate_add_regra_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
with engine.begin() as conn:
    for coluna in Regra.__table__.columns:
...
print("Nenhum dado existente em regras (ou em qualquer outra tabela) foi apagado ou alterado.")
