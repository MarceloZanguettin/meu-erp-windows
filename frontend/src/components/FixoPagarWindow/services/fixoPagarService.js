 ...
 *
 * Usado tanto pelo hook useCrud (lista/edição em FixoPagarWindow) quanto
 * pela janela de criação NovoFixoPagarWindow.
 */
export function normalizarFixoPagar(form) {
  const dados = { ...form };
