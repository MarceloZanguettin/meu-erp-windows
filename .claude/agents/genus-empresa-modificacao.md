---
name: genus-empresa-modificacao
description: Use this agent when asked to adapt this ERP's backend and frontend to recognize all fields of the GENUS legacy table `EMPRESA` (from GENUS_ZANGUETTIN.FDB, a Firebird database being progressively migrated into this project's PostgreSQL-backed ERP -- see the project's `genus-fdb-migration-audit` context). This agent does the *structural* work only (SQLAlchemy model, Pydantic schema, FastAPI controller, additive Postgres migration, frontend window/fields) -- it does NOT import any row data from GENUS. Examples: "roda o agente de modificacao da tabela EMPRESA", "adapta o backend pra reconhecer os campos de EMPRESA", "migra a estrutura de EMPRESA do GENUS".
...
`EMPRESA`, following the exact precedent already established for
...
Provavelmente corresponde ao model Empresa já existente.

## Fields to recognize (GENUS table `EMPRESA`)
...
| CNPJCONT | String(14) |
| NOMECONT | String(45) |
| CPFCNPJCONT | String(14) |
| CRCCONT | String(15) |
| CEPCONT | String(10) |
| ENDERECOCONT | String(50) |
| NUMCONT | String(6) |
| BAIRROCONT | String(35) |
| FONECONT | String(15) |
| FAXCONT | String(15) |
| EMAILCONT | String(60) |
| CODCIDADECONT | Integer |
| REGIME_APURACAO | String(2) |
| REGIME_TRIBUTACAO | String(2) |
| ATIVIDADE_MUNICIPAL | String(20) |
| ATIVIDADE_FEDERAL | String(10) |
| ALIQMUNICIPAL | Float |
| DIASVENCIMENTO | Integer |
| MORA | Float |
| MULTA | Float |
| NUMCERTIFICADO | String(50) |
| CAMINHOLOGO | String(200) |
| CAMINHOXML | String(200) |
| SALVARXML | String(1) |
| INSS | Float |
| FUNDOGARANTIA | Float |
| SENHAPADRAO | String(20) |
| ULTNSU | String(20) |
| CLIENTIDGMAIL | String(150) |
| CLIENTSECRETGMAIL | String(150) |
| TOKENGMAIL | String(150) |
| REFRESHTOKENGMAIL | String(150) |
| CODIGOGMAIL | String(150) |
| RNTRC | String(10) |
| FOTOLOGO | Text |
| AUTENTICAREMAILSSL | String(1) |
| CLASSIFCOMERCIAL | String(2) |
| CODGAREICMS | String(4) |
| ICMSPISCOFINSENTRADA | String(1) |
| ICMSPISCOFINSSAIDA | String(1) |
| SITUACAO | String(1) |
| MAXNSU | String(20) |
| DATAULTIMACONSULTANSU | DateTime |
| HORAULTIMACONSULTANSU | String(8) |
| CALCULARICMSDENTRODOESTADO | String(1) |
| ULTNSUCTE | String(20) |
| MAXNSUCTE | String(20) |
| DATAULTIMACONSULTANSUCTE | DateTime |
| HORAULTIMACONSULTANSUCTE | String(8) |
| REFORMA_TRIBUTARIA | String(1) |
