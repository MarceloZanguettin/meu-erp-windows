"""
Migração aditiva: cria/expande a tabela `carteiras` com as colunas do modelo
Carteira (campos migrados da tabela CARTEIRA do GENUS), sem apagar nada.
...
Execute com: python migrate_add_carteira_fields.py (dentro da pasta backend,
com o venv ativo)
"""
import sys
import os
...
with engine.begin() as conn:
    for coluna in Carteira.__table__.columns:
...
print("Nenhum dado existente em carteiras (ou em qualquer outra tabela) foi apagado ou alterado.")
