"""
Migração aditiva: adiciona à tabela `representantes` as colunas novas do
modelo Representante (campos migrados da tabela REPRESENTANTE do GENUS),
sem apagar nada.
...
Execute com: python migrate_add_representante_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
from models.tabelas import Representante

inspector = inspect(engine)
tabela = Representante.__tablename__
...
with engine.begin() as conn:
    for coluna in Representante.__table__.columns:
...
print("Nenhum dado existente em representantes (ou em qualquer outra tabela) foi apagado ou alterado.")
