"""
Migração aditiva: adiciona à tabela `pedidos_venda` as colunas novas do
modelo PedidoVenda (campos migrados da tabela PEDIDO do GENUS), sem apagar
nada.
...
Execute com: python migrate_add_pedido_venda_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
from models.tabelas import PedidoVenda

inspector = inspect(engine)
tabela = PedidoVenda.__tablename__
...
with engine.begin() as conn:
    for coluna in PedidoVenda.__table__.columns:
...
print("Nenhum dado existente em pedidos_venda (ou em qualquer outra tabela) foi apagado ou alterado.")
