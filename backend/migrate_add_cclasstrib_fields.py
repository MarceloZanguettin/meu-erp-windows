"""
Migração aditiva: cria/expande a tabela `cclasstribs` com as colunas do
modelo CClassTrib (campos migrados da tabela CCLASSTRIB do GENUS), sem
apagar nada.
...
Execute com: python migrate_add_cclasstrib_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
tabela = CClassTrib.__tablename__
...
with engine.begin() as conn:
    for coluna in CClassTrib.__table__.columns:
...
print("Nenhum dado existente em cclasstribs (ou em qualquer outra tabela) foi apagado ou alterado.")
