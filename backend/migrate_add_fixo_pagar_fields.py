"""
Migração aditiva: cria/expande a tabela `fixos_pagar` com as colunas do
modelo FixoPagar (campos migrados da tabela FIXOPAGAR do GENUS), sem apagar
nada.
...
Execute com: python migrate_add_fixo_pagar_fields.py (dentro da pasta
...
tabela = FixoPagar.__tablename__
...
with engine.begin() as conn:
    for coluna in FixoPagar.__table__.columns:
...
print("Nenhum dado existente em fixos_pagar (ou em qualquer outra tabela) foi apagado ou alterado.")
