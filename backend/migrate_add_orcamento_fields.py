"""
Migração aditiva: adiciona à tabela `orcamentos` as colunas novas do modelo
Orcamento (campos migrados da tabela ORCAMENTO do GENUS), sem apagar nada.
...
Execute com: python migrate_add_orcamento_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
from models.tabelas import Orcamento

inspector = inspect(engine)
tabela = Orcamento.__tablename__
...
with engine.begin() as conn:
    for coluna in Orcamento.__table__.columns:
...
print("Nenhum dado existente em orcamentos (ou em qualquer outra tabela) foi apagado ou alterado.")
