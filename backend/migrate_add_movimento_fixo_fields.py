"""
Migração aditiva: cria/expande a tabela `movimentos_fixos` com as colunas
do modelo MovimentoFixo (campos migrados da tabela MOVTOFIXO do GENUS),
sem apagar nada.
...
Execute com: python migrate_add_movimento_fixo_fields.py (dentro da pasta
...
tabela = MovimentoFixo.__tablename__
...
with engine.begin() as conn:
    for coluna in MovimentoFixo.__table__.columns:
...
print("Nenhum dado existente em movimentos_fixos (ou em qualquer outra tabela) foi apagado ou alterado.")
