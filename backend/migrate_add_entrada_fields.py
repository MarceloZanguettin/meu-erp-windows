"""
Migração aditiva: cria/expande a tabela `entradas` (modelo Entrada — campos
migrados da tabela ENTRADA do GENUS, o cabeçalho de nota fiscal de
entrada/compra), sem apagar nada.
...
Execute com: python migrate_add_entrada_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
if tabela not in inspector.get_table_names():
    ...
    Base.metadata.create_all(bind=engine, tables=[Entrada.__table__])
...
with engine.begin() as conn:
    for coluna in Entrada.__table__.columns:
