---
name: genus-sailan-modificacao
description: Use this agent when asked to adapt this ERP's backend and frontend to recognize all fields of the GENUS legacy table `SAILAN` (from GENUS_ZANGUETTIN.FDB, a Firebird database being progressively migrated into this project's PostgreSQL-backed ERP -- see the project's `genus-fdb-migration-audit` context). This agent does the *structural* work only (SQLAlchemy model, Pydantic schema, FastAPI controller, additive Postgres migration, frontend window/fields) -- it does NOT import any row data from GENUS. Examples: "roda o agente de modificacao da tabela SAILAN", "adapta o backend pra reconhecer os campos de SAILAN", "migra a estrutura de SAILAN do GENUS".
...
`SAILAN`, following the exact precedent already established for
...
## Fields to recognize (GENUS table `SAILAN`)
...
| QUANTIDADEPIS | Float |
| ALIQPISREAIS | Float |
| QUANTIDADECOFINS | Float |
| ALIQCOFINSREAIS | Float |
| CUSTO | Float |
| CALCULAIPIBASE | String(1) |
| REDUZIRBASEST | String(1) |
| OBSPRODUTO | Text |
| SEGURO | Float |
| OUTRAS | Float |
| CALCULAIPIBASE_SUBST | String(1) |
| REFFABRICA | String(20) |
| ALIQIBPT | Float |
| QTDEEMBAL | Float |
| NUMPEDIDO | String(15) |
| NUMITEM | String(7) |
...
| DIDT | DateTime |
| DESEMBDT | DateTime |
| DESEMBLOCAL | String(40) |
| DESEMBUF | String(2) |
| DIEXPORTADOR | String(10) |
| DIFABRICANTE | String(10) |
| CENQ | String(3) |
| ICMSFCP | Float |
| ALIQUFDEST | Float |
| ALIQINTER | String(5) |
| PERCPARTILHA | String(5) |
| VLICMSUFDEST | Float |
| VLICMSUFREM | Float |
| VLICMSFCP | Float |
| CREDITO | Float |
...
| CALCOMISSAO | Float |
| VALCOMISSAO | Float |
| CODCLASSIFICACAO2 | Integer |
| QTDEFATURAMENTOPARCIAL | Float |
| CODIGO | Integer |
| CODPREPEDIDO | Integer |
| CODEMPRESAPREPEDIDO | Integer |
| NUMLOTEPRODETAPAS | String(20) |
| REFORMA_CST_IBSCBS | String(3) |
| REFORMA_CCLASSTRIB | String(10) |
| REFORMA_VBC_IBSCBS | Float |
| REFORMA_PIBSUF_IBSUF | Float |
| REFORMA_PDIF_IBSUF | Float |
| REFORMA_VDIF_IBSUF | Float |
| REFORMA_VDEVTRIB_IBSUF | Float |
| REFORMA_PREDALIQ_IBSUF | Float |
| REFORMA_PALIQEFET_IBSUF | Float |
| REFORMA_VIBSUF_IBSUF | Float |
| REFORMA_PIBSMUN_IBSMUN | Float |
| REFORMA_PDIF_IBSMUN | Float |
| REFORMA_VDIF_IBSMUN | Float |
| REFORMA_VDEVTRIB_IBSMUN | Float |
| REFORMA_PREDALIQ_IBSMUN | Float |
| REFORMA_PALIQEFET_IBSMUN | Float |
| REFORMA_VIBSMUN_IBSMUN | Float |
| REFORMA_VIBS | Float |
| REFORMA_PCBS_CBS | Float |
| REFORMA_PDIF_CBS | Float |
| REFORMA_VDIF_CBS | Float |
| REFORMA_VDEVTRIB_CBS | Float |
| REFORMA_PREDALIQ_CBS | Float |
| REFORMA_PALIQEFET_CBS | Float |
| REFORMA_VCBS_CBS | Float |
| REFORMA_CSTREG | String(3) |
| REFORMA_CCLASSTRIBREG | String(10) |
| REFORMA_PALIQEFETREGIBSUF | Float |
| REFORMA_VTRIBREGIBSUF | Float |
| REFORMA_PALIQEFETREGIBSMUN | Float |
| REFORMA_VTRIBREGIBSMUN | Float |
| REFORMA_PALIQEFETREGCBS | Float |
| REFORMA_VTRIBREGCBS | Float |
| REFORMA_CCREDPRES_IBS | String(2) |
| REFORMA_PCREDPRES_IBS | Float |
| REFORMA_VCREDPRES_IBS | Float |
| REFORMA_VCREDPRESCONDSUS_IBS | Float |
| REFORMA_CCREDPRES_CBS | String(2) |
| REFORMA_PCREDPRES_CBS | Float |
| REFORMA_VCREDPRES_CBS | Float |
| REFORMA_VCREDPRESCONDSUS_CBS | Float |
| REFORMA_PALIQIBSUF_GOV | Float |
| REFORMA_VTRIBIBSUF_GOV | Float |
| REFORMA_PALIQIBSMUN_GOV | Float |
| REFORMA_VTRIBIBSMUN_GOV | Float |
| REFORMA_PALIQCBS_GOV | Float |
| REFORMA_VTRIBCBS_GOV | Float |
| REFORMA_VIBS_TRANSFCRED | Float |
| REFORMA_VCBS_TRANSFCRED | Float |
| REFORMA_TPCREDPRESIBSZFM | String(1) |
| REFORMA_VCREDPRESIBSZFM | Float |
| REFORMA_VITEM | Float |
| REFORMA_CHAVEACESSO | String(44) |
| REFORMA_NITEM | Integer |
| REFORMA_CSTIS_IS | String(3) |
| REFORMA_CCLASSTRIBIS_IS | String(10) |
| REFORMA_VBCIS_IS | Float |
| REFORMA_PIS_IS | Float |
| REFORMA_PISESPEC_IS | Float |
| REFORMA_UTRIB_IS | String(10) |
| REFORMA_QTRIB_IS | Float |
| REFORMA_VIS_IS | Float |
| NITEM | Integer |
| REFORMA_VIBSESTCRED | Float |
| REFORMA_VCBSESTCRED | Float |
| REFORMA_INDDOACAO | String(1) |
| CODCBENEF | Integer |
