 ...
 *
 * Usado tanto pelo hook useCrud (lista/edição em BcoSicredWindow) quanto
 * pela janela de criação NovoBcoSicredWindow.
 */
export function normalizarBcoSicred(form) {
  const dados = { ...form };
