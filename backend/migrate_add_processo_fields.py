"""
Migração aditiva: cria/expande a tabela `processos` com as colunas do modelo
Processo (campos migrados da tabela PROCESSO do GENUS), sem apagar nada.
...
Execute com: python migrate_add_processo_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
with engine.begin() as conn:
    for coluna in Processo.__table__.columns:
...
print("Nenhum dado existente em processos (ou em qualquer outra tabela) foi apagado ou alterado.")
