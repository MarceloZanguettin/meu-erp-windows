---
name: genus-funcionario-modificacao
description: Use this agent when asked to adapt this ERP's backend and frontend to recognize all fields of the GENUS legacy table `FUNCIONARIO` (from GENUS_ZANGUETTIN.FDB, a Firebird database being progressively migrated into this project's PostgreSQL-backed ERP -- see the project's `genus-fdb-migration-audit` context). This agent does the *structural* work only (SQLAlchemy model, Pydantic schema, FastAPI controller, additive Postgres migration, frontend window/fields) -- it does NOT import any row data from GENUS. Examples: "roda o agente de modificacao da tabela FUNCIONARIO", "adapta o backend pra reconhecer os campos de FUNCIONARIO", "migra a estrutura de FUNCIONARIO do GENUS".
...
`FUNCIONARIO`, following the exact precedent already established for
...
Provavelmente corresponde ao model Funcionario já existente — precisa fazer join com CADASTRO.

## Fields to recognize (GENUS table `FUNCIONARIO`)
...
| CODEMPRESA | Integer |
| USUARIO | String(15) |
| CADASTROCLIENTE | String(1) |
| BANCO | String(3) |
| AGENCIA | String(5) |
| DIGITOAGENCIA | String(1) |
| DIGITOCONTA | String(1) |
| SALARIO | Float |
| CODCONTAS | Integer |
| CAIXA | String(1) |
| CODGRUPOMENU | Integer |
| SMTP_PORTA | Integer |
| SMTP_HOST | String(60) |
| SMTP_PASSWORD | String(20) |
| SMTP_USERNAME | String(60) |
| FROM_ADDRESS | String(60) |
| FROM_NAME | String(20) |
| CODCARGO | Integer |
| NCARTEIRA | String(20) |
| CAMISA | String(5) |
| SAPATO | String(5) |
| CALCA | String(5) |
| HORASTRABALHADAS | String(7) |
| DT_ADMISSAO | DateTime |
| DT_DEMISSAO | DateTime |
| HORASEFETIVAS | String(7) |
| EXIBEDADOS | String(1) |
| LIBERARPREPEDIDO | String(1) |
| CONSULTARPRODUTO | String(1) |
| ALTERARLOGIN | String(1) |
| RECEBERCOTACAOEMAIL | String(1) |
| PERMITIRANEXOCLIENTE | String(1) |
| PERMITIRINATIVARCLIENTES | String(1) |
| PERMITIRCAMPOBLOQUEADOCLIENTE | String(1) |
| APROVARPREPEDIDO | String(1) |
| VISUALIZARCOTACAOPRECO | String(1) |
| ALTERARLIMITECLIENTE | String(1) |
| PERMITIRIMPRIMIRLGPDCLIENTE | String(1) |
| PERMITIRACESSARCONDPAGAMENTO | String(1) |
| PERMITIRALTERARJUROS | String(1) |
| PERMITIRBAIXARALTERARPARCELAS | String(1) |
| PERMITIRTORNARPARCELASPENDENTES | String(1) |
| PERMITIRREDEFINIRPARCELAS | String(1) |
| PERMITIREXCLUIRPAGARRECEBER | String(1) |
| PERMITIRVISUALIZARCUSTO | String(1) |
| PERMITIRALTERARROMANEIOFECHADO | String(1) |
| PERMITIREXCLUIRROMANEIO | String(1) |
| PERMITIRALTERARUNITSAIDAS | String(1) |
| ACESSARMENUBATELADA | String(1) |
| CODSETOR | Integer |
| PERMITIRANEXOFUNCIONARIO | String(1) |
| CONTA | String(20) |
| CODFUNCAO | Integer |
| CTPS | String(7) |
| SERIE | String(4) |
...
| CBO | String(8) |
| VENDEDOR | String(1) |
| BLOQVISUALIZARFUNCIONARIOS | String(1) |
| AUTENTICAREMAILSSL | String(1) |
