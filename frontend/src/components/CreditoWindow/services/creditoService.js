 ...
 *   Optional[int]/Optional[float]/Optional[datetime] com string vazia;
 * - converte campos inteiros/decimais de string para Number.
 *
 * Usado tanto pelo hook useCrud (lista/edição em CreditoWindow) quanto pela
 * janela de criação NovoCreditoWindow.
 */
export function normalizarCredito(form) {
  const dados = { ...form };
