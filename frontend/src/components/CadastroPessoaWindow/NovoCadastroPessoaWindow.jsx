...
export default function NovoCadastroPessoaWindow({ id, onClose, onMinimize, onSalvar }) {
  const [form, setForm] = useState({ ...FORM_VAZIO });

  const salvar = async () => {
    const r = await fetch(`${API}/cadastro-pessoas`, {
      method: 'POST',
  ...
  return (
    <CadastroFormWindow
      id={id} titulo="Novo Cadastro" onClose={onClose} onMinimize={onMinimize} onSalvar={onSalvar}
