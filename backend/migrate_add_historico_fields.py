"""
Migração aditiva: cria/expande a tabela `historicos` com as colunas do
modelo Historico (campos migrados da tabela HISTORICO do GENUS), sem apagar
nada.
...
Execute com: python migrate_add_historico_fields.py (dentro da pasta backend, com o venv ativo)
"""
import sys
import os
...
tabela = Historico.__tablename__
...
with engine.begin() as conn:
    for coluna in Historico.__table__.columns:
...
print("Nenhum dado existente em historicos (ou em qualquer outra tabela) foi apagado ou alterado.")
